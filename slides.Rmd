...
knitr::include_graphics("examples/pies_are_bad.svg")
```
...
![Sankey Diagram of Napoleon's invasion of russia](examples/SankeyMinard.png)
...
knitr::include_graphics("examples/GM9_kipXkAA9RZs.jpg")
```
...
|:-- | :-- |
| ![Treemap of the UK exports in 2019.](examples/United_Kingdom_Product_Exports_2019.svg) | ![Key for said treemap.](examples/export_key.png) |
...
| :--------------------- | :--------------------- | :-------------------- |
|![](examples/United-Kingdom_PVOUT_Photovoltaic-power-potential-map_GlobalSolarAtlas_World-Bank-Esmap-Solargis.png)|![](examples/H1N1_United_Kingdom_Map_-_Region_3.svg)|![](examples/2019_UK_general_election_constituency_map.svg)|
...
| Example 1 | Example 2 |
| :-------: | :-------: |
| ![](examples/bad_pie1.png) | ![](examples/bad_pie2.jpg) 
...
![](examples/blog-misleading-y-axis.png)
...
![](examples/economist-linegraph.png)
